...
public class MainActivity extends AppCompatActivity {
    ...
    String nomePlanetas[] = {"Jupiter", "Lua", "Marte", "Mercurio", "Netuno", "Plutao", "Saturno", "Sol", "Terra", "Urano", "Venus"};
    int imagemPlanetas[] = {R.drawable.jupiter, R.drawable.lua, R.drawable.marte, R.drawable.mercurio, R.drawable.netuno, R.drawable.plutao, R.drawable.saturno,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaPlanetas = findViewById(R.id.isListaPlanetas);
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            //Declarar os componentes do  modelo que serao utilizados na lista
            ...
            //implemnetar os metodos nos componentes
